...
![GitHub Repo stars](https://img.shields.io/github/stars/bcdxn/opencli)
...
The OpenCLI CLI is generated by the OpenCLI CLI 🤯

- View the [OpenCLI Spec document](https://github.com/bcdxn/opencli/blob/main/opencli.ocs.yaml)
- View the generated [Markdown docs](https://github.com/bcdxn/opencli/blob/main/docs/opencli.ocs.md)
- View the generated [HTML docs](https://opencli.dev/docs)
- View the generated [boilerplate CLI code](https://github.com/bcdxn/opencli/tree/main/internal/cli/gencli)
