...
func defaultTestSpecJSON(t *testing.T, flagObj string) []byte {
	...
	doc := `{"opencliVersion":"` + spec.SchemaVersion + `","info":{"title":"default test","version":"0.1.0","binary":"deftest"},"commands":{"root":{"flags":[` + flagObj + `]}}}`
...
func globalFlagSpecJSON(t *testing.T, flagObj string) []byte {
	...
	doc := `{"opencliVersion":"` + spec.SchemaVersion + `","info":{"title":"default test","version":"0.1.0","binary":"deftest"},"global":{"flags":[` + flagObj + `]},"commands":{"root":{}}}`
